...
// Apenas exportador e importador têm conta/cadastro na plataforma.
// Os demais atores da cadeia são parceiros fixos fornecidos pelo backend
// (ver partner-service / mock service_providers), não entidades cadastráveis.
