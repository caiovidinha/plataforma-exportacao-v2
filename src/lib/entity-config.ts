...
export const ENTITY_CONFIG: Record<EntitySlug, EntityConfig> = {
  ...
  importador: {
    ...
    description: 'Compradores internacionais que importam castanha-do-Brasil do Brasil.',
    icon: 'Building2',
    color: 'text-blue-400',
    bg: 'bg-blue-400/10',
    cnpjLabel: 'VAT / Tax ID',
    specificFields: [
      { key: 'country_code', label: 'País', type: 'text', placeholder: 'Ex.: DE, US, NL', required: true },
      ...
      { key: 'ministry_registration', label: 'Nº de registro no Ministério da Agricultura local', type: 'text' },
    ],
  },
  transportadora: {
    slug: 'transportadora',
    ...
    bg: 'bg-orange-400/10',
    specificFields: [
      { key: 'ufs_cobertas', label: 'Estados atendidos', type: 'text', placeholder: 'Ex.: AM, PA, RO, MT', required: true },
      { key: 'tipos_veiculo', label: 'Tipos de veículo', type: 'text', placeholder: 'Ex.: Caminhão Baú, Carreta Frigorífica' },
  ...
  'companhia-navegacao': {
    ...
    bg: 'bg-cyan-400/10',
    specificFields: [
      { key: 'ports_covered', label: 'Portos de Origem atendidos', type: 'text', placeholder: 'Ex.: Santos, Belém, Itajaí', required: true },
      { key: 'routes', label: 'Principais rotas', type: 'text', placeholder: 'Ex.: Santos → Rotterdam' },
      { key: 'transit_time_days', label: 'Tempo médio de trânsito (dias)', type: 'number', placeholder: 'Ex.: 21' },
      { key: 'container_types', label: 'Tipos de container disponíveis', type: 'text', placeholder: 'Ex.: Dry 20\', Dry 40\', Reefer' },
      { key: 'vessel_types', label: 'Tipos de embarcação', type: 'text', placeholder: 'Ex.: Contêiner, Graneleiro' },
  ...
  certificadora: {
    ...
    specificFields: [
      ...
      { key: 'cod_autorizado', label: 'Autorizada emitir Certificado de Origem (CO)?', type: 'select', options: ['Sim','Não'] },
