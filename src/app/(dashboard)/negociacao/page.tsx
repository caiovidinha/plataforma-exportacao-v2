...
export default async function NegociacaoPage() {
  ...
  const statusCfg = {
    ...
    ACORDO_FECHADO: { label: t('statusClosed'), cls: 'text-emerald-400 bg-emerald-400/10 border-emerald-400/30', icon: CheckCircle2 },
      ...
      <div className="space-y-3">
        ...
        {negotiations.length === 0 && (
          <div className="card text-center py-12">
            ...
            <p className="text-slate-400 text-sm">{t('noNegotiations')}</p>
