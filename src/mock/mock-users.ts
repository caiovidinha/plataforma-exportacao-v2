...
// (exportador e importador - os 2 únicos tipos de conta na plataforma)
...
export const MOCK_USERS: Record<EntitySlug, MockUser> = {
  exportador: {
    ...
    stats: [
      ...
      { label: 'listedListings',    value: 4 },
      { label: 'pendingOrders',     value: 3 },
  ...
  importador: {
    ...
    role_label: 'Importer',
    stats: [
      { label: 'browsingListings',  value: 3 },
      { label: 'pendingOrders',     value: 2 },
