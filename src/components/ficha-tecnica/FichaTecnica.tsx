...
const TABS = [
  ...
  { id: 'organoléptico', label: 'Organoléptico', icon: Leaf },
  { id: 'fisicoquimico', label: 'Físico-Químico', icon: FlaskConical },
  { id: 'nutricional', label: 'Nutricional', icon: Microscope },
  { id: 'exigencias', label: 'Exigências Legais', icon: ShieldCheck },
] as const
